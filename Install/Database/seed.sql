...
VALUES 
	('Class 1: Mathematics in the World Around Us', 'Students learn basic mathematical concepts such as numbers and operations. They become familiar with numbers up to 20, practicing addition and subtraction, recognizing shapes, and comparing lengths and volumes. The lessons are enriched with games and fun math activities.'),
	('Class 2: Introduction to Arithmetic', 'In this grade, students develop their addition and subtraction skills up to 100 and begin learning multiplication and division. They also learn about time, money, and basic measurements of length. Students are taught to solve simple math problems and apply math in everyday life.'),
	('Class 3: Development of Arithmetic Skills', 'Students deepen their knowledge of multiplication and division up to 1000. They learn about fractions, geometric shapes, and the basic properties of figures. Concepts such as symmetry and perimeter are introduced, along with skills in collecting and analyzing data.'),
	('Class 4: Basics of Geometry and Fractions', 'Students learn about different types of fractions, including proper and improper fractions and decimals. They develop geometric skills by exploring basic shapes and their properties. The introduction of simple equations and algebraic expressions presents new challenges.'),
	('Class 5: Algebra and Statistics', 'Students learn to solve equations and perform operations on algebraic expressions. They are introduced to concepts related to statistics, such as mean, median, and mode. Topics related to percentages are also covered, preparing them for more complex concepts in the future.'),
	('Class 6: Advanced Geometry and Algebra', 'In this grade, students develop skills for solving equations with one variable and work on concepts of ratios and reciprocals. They learn about three-dimensional figures and their volumes, as well as tackle more complex geometric problems.'),
	('Class 7: Introduction to Higher Mathematics', 'Students learn more advanced algebra, including linear and quadratic functions. They develop skills in data analysis and discover various methods for solving mathematical problems. The introduction of trigonometry and basic concepts related to angles and radii also takes place in this grade.'),
	('Class 8: Preparation for High School Mathematics', 'Students completing elementary school have the opportunity to integrate their acquired knowledge. In this grade, topics such as functions, quadratic equations, and more advanced concepts in statistics and probability are discussed. Preparation for the final exam includes both practical and theoretical tasks to ensure a solid understanding of mathematics at the high school level.')
;
...
VALUES
    ...
    (21, 'What is the area of a circle with a radius of 3 cm?', '28.26 cm²', 'Area = πr² = 3.14 × (3)² ≈ 28.26 cm².'),
